                ...
                <div className="row">
                    ...
                    <form id="application-form" action="/index.php/personal/form/personal" method="post" enctype="multipart/form-data">
                        ...
                        <div className="card mt-8">
                            ...
                            <div className="card-body">
                                <div className="row">
                                    <div className="col-md-6"><div className="mb-3 field-jiuserpersonal-existing_student required">



                                        <div className="invalid-feedback"></div>
                                    </div></div>
                                    <div id="studentId" className="row" style={{ display: 'none' }}>
                                        {/* <div className="col-md-6">
                                            <div className="mb-3 field-jiuserpersonal-existing_studentid">
                                                <label className="form-label" for="jiuserpersonal-existing_studentid">CSU Enrollment/Registration No.<sup style={{ color: 'red' }}>*</sup></label>
                                                <input type="text" id="jiuserpersonal-existing_studentid" className="form-control" name="JIUserPersonal[existing_studentId]" maxlength="30" prompt="Enter University Roll No." />

                                                <div className="invalid-feedback"></div>
                                            </div>
                                        </div> */}
                                        <div className="col-md-6">
                                            <div className="mb-3 field-jiuserpersonal-ou_id">
                                                <label className="form-label" for="jiuserpersonal-ou_id">NFSE Centre/ Name of the CSU Campus/School/Department<sup style={{ color: 'red' }}>*</sup></label>
                                                <input type="text" id="jiuserpersonal-ou_id" className="form-control" name="JIUserPersonal[ou_id]" maxlength="255" />

                                                <div className="invalid-feedback"></div>
                                            </div>                    </div>
                                        <div className="col-md-6">
                                            <div className="mb-3 field-jiuserpersonal-programme_id">
                                                <label className="form-label" for="jiuserpersonal-programme_id">Programme registered in  <sup style={{ color: 'red' }}>*</sup></label>
                                                <input type="text" id="jiuserpersonal-programme_id" className="form-control" name="JIUserPersonal[programme_id]" maxlength="255" />

                                                <div className="invalid-feedback"></div>
                                            </div>                    </div>
                                        <div className="col-md-6">
                                            <div className="mb-3 field-jiuserpersonal-year_of_registration">
                                                <label className="form-label" for="jiuserpersonal-year_of_registration">Year of Registration  <sup style={{ color: 'red' }}>*</sup></label>
                                                <select id="jiuserpersonal-year_of_registration" className="form-select" name="JIUserPersonal[year_of_registration]" maxlength="10">
                                                    <option value="">Select</option>
                                                    <option value="2023">2023</option>
                                                    <option value="2022">2022</option>
                                                    <option value="2021">2021</option>
